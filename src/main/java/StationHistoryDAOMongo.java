...
public class StationHistoryDAOMongo extends
		BasicDAO<StationHistoryEntry, ObjectId> {
	...
	public List<StationHistoryEntry> findStarredByUserId(ObjectId userId) {
		...
		query.and(
				...
				query.criteria("songFeedback.feedbackType").in(
						Arrays.asList(SongFeedback.FeedbackType.STAR)));
